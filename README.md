...
```
Notebooks on the gen_ai and unsupported_examples folders are not properly maintained - some of them will be reviewed for including in the repository, some of then will be removed for being redundant
```
