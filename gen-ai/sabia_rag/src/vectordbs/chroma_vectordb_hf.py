...
class ChromaVectorDBHf(VectorDB):
    """
    ...
    def __init__(self, embedding_model: EmbeddingsModel, collection_name: str = "SabIA_collection", distance_function: str = None) -> None:
        ...
        self.client = chromadb.PersistentClient(path="./data/vectordb_data")
    ...
    def query(self, text: str, filters:dict = None) -> Any:
        ...
        data = self.collection.query(self.embbeding.embed(text), where=filters, n_results=5)
        chunks = []
